...
pub async fn refresh_access_token_handler(
    ...
    let refresh_token_details = 
        match token::verify_jwt_token(data.env.refresh_access_token_public_key.to_owned(), &refresh_token)
        {
    ...
    let mut redis_client = data
        ...
        save_token_data_to_redis(&data, &access_token_details, data.env.access_token_details).await?;
